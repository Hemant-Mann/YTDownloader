    					        ...
    					        <div class="containter">
    					        	<div class="row">
    					        		...
    					        		<div class="col-lg-6 col-md-6">
    					        			<input type="text" name="videoId" class="form-control" id="url" required="" placeholder="Enter Youtube Video URL" value="<?php echo (isset($videoId) ? $videoId : ""); ?>">
    					        		</div>
    					        	</div>
    					        </div>
    					    </div>
